...
pub fn create_color_attachment_image(
    ...
    let usage = vk::ImageUsageFlags::ColorAttachment
...
pub fn create_depth_attachment_image(
    device: &vk::Device,
    allocator: &Arc<Mutex<Allocator>>,
    width: u32,
    height: u32,
    ...
    let usage = vk::ImageUsageFlags::DepthStencilAttachment;
    create_attachment_image(
        device,
        allocator,
        width,
...
fn create_attachment_image(
    ...
    let allocation = allocator
        ...
        .expect("failed to allocate attachment image memory");

    unsafe {
        device
            .bind_image_memory(image, allocation.memory(), allocation.offset())
            .expect("failed to bind attachment image memory");
    }
    ...
    let view = device
        ...
        .expect("failed to create attachment image view");
