...
pub struct Translation {
    ...
    login_hello_id: u32,
    /// Whether the wire version's `game_profile` ends in the
    /// `strictErrorHandling` bool 1.20.5 added and 1.21.2 replaced with the
    /// session UUID; see [`Translation::translate_login_frame`].
