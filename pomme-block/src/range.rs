...
use azalea_registry::tags::RegistryTag;

use crate::BlockState;
use crate::block_state::BlockStateIntegerRepr;
...
/// Data-free stub: without block tables a kind maps to no states. Only
/// consumed by azalea-world's `find_blocks`, which pomme doesn't use.
impl From<BlockKind> for BlockStates {
    fn from(_block: BlockKind) -> Self {
        Self {
            set: HashSet::new(),
        }
    }
