...
- **Multi-version protocol support**: connects to vanilla servers from 1.21.6 through 26.2, with per-version packet-id and registry tables generated from the decompiled reference; handles chunk streaming, block updates, chat
